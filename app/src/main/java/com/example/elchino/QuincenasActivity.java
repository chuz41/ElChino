...
public class QuincenasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quincenas);
        tv_saludo = (TextView) findViewById(R.id.tv_saludo);
        tv_saludo.setText("*** CLIENTES QUINCENALES ***");
    ...
    private void acondicionarMensaje (String contenido) {
        Log.v("acondicionarMensaje_0", "Quincenas.\n\ncontenido: " + contenido + "\n\n.");
        String cuadratura = "";
        if (!contenido.equals("")) {
            ...
            for (int i = 0; i < split_contenido.length; i++) {
                ...
                try {
                    Log.v("acondicionarMensaje_1", "Quincenas.\n\nnombre_archivo: " + nombre_archivo + "\n\n.");
                    ...
                    while (linea != null) {
                        Log.v("acondicionarMensaje_2", "Quincenas.\n\nlinea: " + linea + "\n\n.");
            ...
            tv_multiline.setText("No hay clientes quincenales.");
            bt_imprimir.setVisibility(View.INVISIBLE);
        }
    }
