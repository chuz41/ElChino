...
public class Pagan_hoy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pagan_hoy);
        tv_saludo = (TextView) findViewById(R.id.tv_saludo);
        tv_saludo.setText("*** COBROS DE HOY ***");
    ...
    private void llenarSpinner() {
        ...
        List<String> keys = new ArrayList<>(mapMorosos.keySet());
        Collections.sort(keys);
        keys.add(0, "Cliente a consultar...");
        ...
        spinner.setOnItemSelectedListener(
                new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if (seleccion.equals("Cliente a consultar...")) {
                            spinnerListener();
                        } else {
